...
public class TiVoLibraryUpdater extends DatabaseUtility {
      ...
      if (seriesObject == null) {
        ...
        if (existingTiVoEpisode == null) {
          ...
          if (updateAllFieldsMode) {
            ...
            updatedShows++;
          } else if (hasTiVoInformation(existingTiVoEpisode) && !lookAtAllShows) {
  ...
  private static Boolean hasTiVoInformation(DBObject episode) {
    return Boolean.TRUE.equals(episode.get("OnTiVo"));
  }

  private static DBObject findTiVoMatch(BasicDBList episodes, String programId) {
    if (episodes == null) {
      return null;
    }
  ...
  private static DBObject findTVDBMatch(String episodeTitle, String episodeNumberStr, String startTimeStr, BasicDBList tvdbEpisodes) {
  ...
  private static DBObject addNewEpisode(Map<String, String> attributeMap, List<String> dateAttributes, String url, Boolean isSuggestion, NodeList showDetails) {
  ...
  private static BasicDBObject updateEpisode(Map<String, String> attributeMap, List<String> dateAttributes, String url, Boolean isSuggestion, NodeList showDetails, DBObject existingProgram) {
    BasicDBObject episodeObject = new BasicDBObject();
    for (String fieldName : attributeMap.keySet()) {
